window.sr = ScrollReveal({reset:true, scale: 1.0, opacity: 0});
// landing page
sr.reveal('.fade-in', {duration:2000, origin:'left', distance: '50px'});
revealMeal();
// meal page
function revealMeal() {
    sr.reveal('.food-image', {duration: 3000, origin:'left', distance: '300px'});
    sr.reveal('.food-name', {duration: 2000, origin: 'top', distance: '225px'});
    sr.reveal('.food-description', {duration: 2000, delay: 500, origin: 'bottom', distance: '300px'});
    sr.reveal('#quantity', {duration: 3000, origin: 'right', distance: '900px'});
    sr.reveal('.order-size', {duration: 3000, delay:600, origin: 'right', distance: '900px'});
    sr.reveal('.make-order', {duration: 3000, delay: 1000, origin: 'bottom', distance: '900px'});
}
